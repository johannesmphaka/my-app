...
export default function Dashboard() {
  ...
  //   const handleNavigationItemClick = (name: any) => {
  //     setSelectedNavItem(name);
  //   };

  const handleNavigationItemClick = (name: any) => {
    // Update the current property of the navigation items
    ...
    setSelectedNavItem(name);
    // setNavigation(updatedNavigation); // You need to manage the state for navigation items
  };
